...
/**
 * PostgreSQL Schema for FamilyPlate
 * Converted from MySQL schema for Vercel Postgres deployment
 */
...
export const userPreferences = pgTable(
  "user_preferences",
  {
    ...
    meatFrequency: integer("meat_frequency").notNull().default(3), // Default: Often
    chickenFrequency: integer("chicken_frequency").notNull().default(3),
    fishFrequency: integer("fish_frequency").notNull().default(3),
    vegetarianFrequency: integer("vegetarian_frequency").notNull().default(2), // Default: Sometimes
    veganFrequency: integer("vegan_frequency").notNull().default(1), // Default: Rarely
    spicyFrequency: integer("spicy_frequency").notNull().default(2),
    kidFriendlyFrequency: integer("kid_friendly_frequency").notNull().default(2),
    healthyFrequency: integer("healthy_frequency").notNull().default(3),
 ...
 */
export const mealVotes = pgTable(
  "meal_votes",
  {
    id: integer("id").primaryKey().generatedAlwaysAsIdentity(),
 ...
 */
export const dishVotes = pgTable(
  "dish_votes",
  {
    id: integer("id").primaryKey().generatedAlwaysAsIdentity(),
    userId: integer("user_id").notNull(),
    dishName: varchar("dish_name", { length: 255 }).notNull(),
    liked: integer("liked").notNull(), // 1 = thumbs up, 0 = thumbs down
...
export const magicLinkTokens = pgTable(
  "magic_link_tokens",
  {
    ...
    used: boolean("used").notNull().default(false), // false = unused, true = used

...
export function useAuth(options?: UseAuthOptions) {
  ...
  const fetchUser = useCallback(async () => {
    ...
    try {
      ...
      // Web platform: use token-based auth (same as native)
      // This avoids cookie domain issues in development
      if (Platform.OS === "web") {
        console.log("[useAuth] Web platform: checking for session token...");

...
## Fix Promoter Access Section
- [ ] Debug email submission error in promoter section
- [ ] Fix tRPC request format if needed
- [ ] Test promoter email signup flow

## Deploy Backend to Vercel
- [x] Configure Vercel deployment settings
- [ ] Set up Vercel Postgres database
- [x] Update database schema for Postgres
